Here you find the flowlines output coming from r.flow algorithm in GRASS-GIS applied on the multy_year_velocity dataset (multy_year_vv_SITE_A) at the site A studied.
Subsequently, by the use of the DEM that you can find the RAW DATA (GrIS_Digital_elevation_model_90m_v01.1) along with the GRASS output we draw the five
flow lines of this site A
