# -*- coding: utf-8 -*-
"""
Preprocessing script for MAR SMB data (1985–2015).
It reads yearly MAR NetCDF files, sums over time, applies the Rignot mask, 
and writes the final masked cumulative SMB field to a new NetCDF file.
...
# Output folder
output_file = os.path.join(ROOT, "..", "..", "Data", "PROCESSED", "MET_GLACIO_PARAMETERS", "SMB_1985_2015.nc")

# Initialize an array of zeros for cumulative SMB (grid size 135x73 in MAR)
z = np.zeros((135, 73))

# Variable of interest: Surface Mass Balance
for q in ["SMB"]:
