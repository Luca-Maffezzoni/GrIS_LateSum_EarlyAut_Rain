...
# variables temperature above surface at 2 meters (TTZ) albedo (AL1) and Sublimation-Evaporation (SU) over Greenland. 
...
for q in ["SU","TTZ","AL1"]:
    ...
    for x in files:
        ...
        z=fileobj.variables[q][151,0,:,:]
        for m in range(152,243):
            shf=fileobj.variables[q][m,0,:,:]
