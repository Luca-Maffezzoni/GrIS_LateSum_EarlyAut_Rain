...
# variables as melt (ME) and runoff (RU) over Greenland. 
...
# results into new NetCDF files for glaciological autumn analysis. 
...
for q in VARIABLES:
    ...
    for x in FILES:
        ...
        # ------------------------------------------------------------
        # AUTUMN EXTRACTION — EXACTLY YOUR ORIGINAL LEAP/NON-LEAP LOGIC
        # ------------------------------------------------------------
        ...
        nc.title = f"parameter_{q}_autumn_{year}"
        nc.close()