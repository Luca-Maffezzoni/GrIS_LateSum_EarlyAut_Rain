...
for q in ["RU"]:
    for i in range(2013,2014):
        ...
        z1=fileobj1.variables[q][82:92,:,:]
        data1=N.reshape(z1,(10,135,73))
        ...
        z2=fileobj2.variables[q][0:1,:,:]
        data2=N.reshape(z2,(135,73))
#       data_sum2=N.sum(data2, axis=0)
        
        ma_data_5 = MA.masked_where(((mask < 219) | (mask > 220)),data2)
