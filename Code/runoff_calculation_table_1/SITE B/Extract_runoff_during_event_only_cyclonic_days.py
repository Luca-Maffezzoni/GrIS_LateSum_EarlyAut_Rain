# -*- coding: utf-8 -*-
"""
Created on Mon Mar 22 16:05:44 2021
...
output_file = os.path.join(
    ...
    "runoff_during_event_only_cyclonic_days.txt"
)
...
for q in ["RU"]:
    for h in range(2015,2016):
        ...
        z1=fileobj1.variables[q][89:92,:,:]
        data1=N.reshape(z1,(3,135,73))
