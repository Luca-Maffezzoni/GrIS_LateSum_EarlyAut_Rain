...
# Initialize empty array for concatenation
# Shape: (1, 135, 73) → dummy row that will be removed later
...
for i in range(1985, 2016):
    ...
    # EXTRACT VALUES
    # =========================
    # Select 10 time steps (239–248) at first vertical level (0)
    z = fileobj.variables[q][239:249, :, :]
    # Reshape data into (10, 135, 73)
...
# =========================
# Reshape into (311, 135, 73): 31 years × 10 days = 310 → plus initial dummy row
data_mean_concatenate_finali = N.reshape(data_mean_concatenate, (311, 135, 73))

# Remove first dummy row → shape becomes (310, 135, 73)
data_mean_preparati = data_mean_concatenate_finali[1:, :, :]

# Compute mean climatology (310 timesteps averaged into 1 map)
