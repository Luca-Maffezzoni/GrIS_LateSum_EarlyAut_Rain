# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 16:33:21 2020
...
output = os.path.join(
    ROOT, "..", "..", "..",
    "Data", "PROCESSED", "SEB_PARAMETERS", "SITE_B",
    "aug_sept_2015_daily_LWU.txt"
)
